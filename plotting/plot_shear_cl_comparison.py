...
for i in bins:
    for j in bins:
        if i >= j:
            ...
            bp_best = open_dat(save_dir + 'theory_cls_1x2ptE_best/shear_cl/PCl_Bandpowers_EE_bin_{}_{}.txt'.format(i,j))
...
plt.savefig(save_dir + 'shear_cl_bestfit.png')
plt.show()
...
plt.savefig(save_dir + 'shear_cl_bestfit_residuals.png')
plt.show()

...
save_dir = '/raid/scratch/wongj/mywork/3x2pt/Final_Data/3BIN_EQUIZ/'
nbins = 3
...
for i in bins:
    for j in bins:
        ...
        bp_best = open_dat(save_dir + 'theory_cls_3x2pt_best/galaxy_shear_cl/PCl_Bandpowers_gal_E_bin_{}_{}.txt'.format(i, j))
...
plt.savefig(save_dir + 'galaxy_shear_cl_bestfit.png')
plt.show()
...
for i in bins:
    for j in bins:
        if i >= j:
            ...
            bp_best = open_dat(
                save_dir + 'theory_cls_3x2pt_best/galaxy_shear_cl/PCl_Bandpowers_gal_E_bin_{}_{}.txt'.format(i, j))
...
plt.savefig(save_dir + 'galaxy_shear_cl_bestfit_residuals.png')
plt.show()

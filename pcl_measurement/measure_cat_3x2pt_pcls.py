...
def maps_from_cats(config_dict, iter_no):
    ...
    ----------
    config_dict : (dict)
        Dictionary containing the measurement parameters (e.g. redshift range, Healpix resolution) to
...
def measure_00_pcls(lmin_out, lmax_out, cut_maps_dic, spectra_type, bin_i, bin_j, measured_pcl_save_dir):
    ...
    cut_maps_dic : (dict)
        Dictionary of tomographic 3x2pt maps to measure power spectra from -
        generated by maps_from_cats()
    spectra_type : (str)
        Spectra type that is measured. For 00, must be either 'gal-gal' for the galaxy overdensity,
...
def measure_02_pcls(lmin_out, lmax_out, cut_maps_dic, spectra_type, bin_i, bin_j, measured_pcl_save_dir):
    ...
    cut_maps_dic : (dict)
        ...
        generated by maps_from_cats()
    spectra_type : (str)
        Spectra type that is measured. For 02, must be either 'TE' or 'TB' for the cosmic shear, or
...
def measure_22_pcls(lmin_out, lmax_out, cut_maps_dic, spectra_type, bin_i, bin_j, measured_pcl_save_dir):
    ...
    cut_maps_dic : (dict)
        ...
        generated by maps_from_cats()
    spectra_type : (str)
        Spectra type that is measured. For 22, must be either 'EE', 'EB', 'BE' or 'BB' for the
        cosmic shear
    bin_i : (float)
        Tomographic bin id number of the first field
    bin_j : (float)

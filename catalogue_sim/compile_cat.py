...
def execute_cat_compilation():
    ...
    master_cat2 = h5py.File(cat_sav_dir + 'gauss_master_cat_poisson_sampled_%s.hdf5' % iter_no, 'w')
    master_cat2.create_dataset("RA", data=ras, compression="gzip")
    master_cat2.create_dataset("Dec", data=decs, compression="gzip")
    master_cat2.create_dataset("Redshift_z", data=phot_zs, compression="gzip")
    master_cat2.create_dataset("Gaussian_Redshift_z", data=phot_zs, compression="gzip")
    master_cat2.create_dataset("True_Redshift_z", data=zs, compression="gzip")
    master_cat2.create_dataset("Convergence", data=convergence_vals, compression="gzip")
    master_cat2.create_dataset("Shear_y1", data=shear1_vals, compression="gzip")
    master_cat2.create_dataset("Shear_y2", data=shear2_vals, compression="gzip")
    master_cat2.create_dataset("Shear_y1_true", data=shear1_vals_true, compression="gzip")
    master_cat2.create_dataset("Shear_y2_true", data=shear2_vals_true, compression="gzip")
    master_cat2.create_dataset("Healpix_Index_(Position)", data=inds, compression="gzip")
    master_cat2.close()

    master_cat3 = h5py.File(cat_sav_dir + 'nonoise_master_cat_poisson_sampled_%s.hdf5' % iter_no, 'w')
    master_cat3.create_dataset("RA", data=ras, compression="gzip")
    master_cat3.create_dataset("Dec", data=decs, compression="gzip")
    master_cat3.create_dataset("Redshift_z", data=zs, compression="gzip")
    master_cat3.create_dataset("Gaussian_Redshift_z", data=zs, compression="gzip")
    master_cat3.create_dataset("True_Redshift_z", data=zs, compression="gzip")
    master_cat3.create_dataset("Convergence", data=convergence_vals, compression="gzip")
    master_cat3.create_dataset("Shear_y1", data=shear1_vals, compression="gzip")
    master_cat3.create_dataset("Shear_y2", data=shear2_vals, compression="gzip")
    master_cat3.create_dataset("Shear_y1_true", data=shear1_vals_true, compression="gzip")
    master_cat3.create_dataset("Shear_y2_true", data=shear2_vals_true, compression="gzip")
    master_cat3.create_dataset("Healpix_Index_(Position)", data=inds, compression="gzip")
    master_cat3.close()

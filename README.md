...
packages, which have been forked/redeveloped from https://github.com/robinupham/gaussian_cl_likelihood, https://github.com/robinupham/angular_binning (references therein, Upham+21)
...
and from the Requirements, ```NaMaster``` (Alonso+18), https://arxiv.org/pdf/1809.09603 may need to be installed from source or via conda depending on the local machine 
...
**(NOTE: Documentation incomplete and codebase not regularly overseen at present)**
